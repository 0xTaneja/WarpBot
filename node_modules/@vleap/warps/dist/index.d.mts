...
declare class WarpActionExecutor {
    ...
    getTxComponentsFromInputs(action: WarpContractAction | WarpQueryAction, inputs: string[], inputTransfers: TokenTransfer[]): {
        args: string[];
        value: bigint;
